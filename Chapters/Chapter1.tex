...
\chapter{Revue de Littérature sur la \glsentrylong{cla}}
\minitoclt
...
\section{Origine et historique du \glsentrytext{spodo} (\glsentrylong{cla})}
...
\section{Biologie du \glsentrytext{spodo}}
Le cycle biologique comprend l'œuf, 6 étapes de développement de la chenille (stades larvaires), la pupe et la noctuelle (adulte) \autocite{fao201812}.
...
\section{Plantes hôtes du \glsentrytext{spodo}}
...
\section{Distribution géographique du \glsentrytext{spodo} en Afrique}
...
\section{Prévention et contrôle du \glsentrytext{spodo}}
