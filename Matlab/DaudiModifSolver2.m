...
ta = [3 7]; % Times before transformation in cterpillar and adult respectively
h = (T)/(T*20);
...
% Solution for different stage
    for stage = 1:1:3 % 1 correspond to the vegetative stage, 2 for the
        ...
        % Variables initial value
            ...
            % Intermeadiate function
                interFun = @(t,y) daudiModif2(t, y, coef, drate, ta, t0);
