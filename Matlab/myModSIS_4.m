function [t,s] = myModSIS_4(s0, coef, drate, I)
...
g = @(x) an*x;
myfSIS = @(t,y) [rr * y(2) - g(y(1))*y(4)/(y(1) + y(2));% * exp(-rr*t);
    - rr * y(2) + g(y(1))*y(4)/(y(1) + y(2)) - m(t) * y(2);% * y(4);
    m(t) * y(2);% * y(4);
    - e * g(y(1))*y(4)/(y(1) + y(2)) + ga*y(6) - d*y(4) - uy*y(4);
    (e*g(y(1))/(y(1) + y(2)) + d) * y(4) - uz*y(5);
