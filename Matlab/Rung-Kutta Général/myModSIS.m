function [t,s] = myModSIS(s0, coef, drate, I)
...
%% Résolution
f = @(x) l*exp(-l*x);%l*x;%*(x/k - 1); f(y(1))
g = @(x) an*x ;
myfSIS = @(t,y) [rr * y(2) - g(y(1))*y(4);% * exp(-rr*t);
    - (rr * y(2) - g(y(1))*y(4)) - f(y(2));% * y(4);
    f(y(2));% * y(4);
    - e * g(y(1)) * y(4) + ga*y(6) - d*y(4) - uy*y(4);
    e*g(y(1))*y(4) + d*y(4) - uz*y(5);
