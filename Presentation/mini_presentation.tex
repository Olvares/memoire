\input{bibSettings/packages}
\input{bibSettings/commandes}
...
\begin{document}
	...
	\begin{frame}{Ce qui a été fait}{Variables d'état du modèle}
		\small
		\begin{table}
			\centering
	...
	\begin{frame}{Ce qui a été fait}{Paramètres du modèle}
		\small
		\begin{table}
			\centering
	...
	\begin{frame}{Ce qui a été fait}{Hypothèses du modèle}
	...
	\begin{frame}[label=Dmodel]{Ce qui a été fait}{Le modèle en cas de non immigration}
		\begin{block}{Stade Végétative ($0 \le t \le t_1$)}
			\begin{equation}
				\left\{\begin{array}{l}
	...
	\begin{frame}{Ce qui a été fait}{Le modèle en cas de non immigration}
		\begin{block}{Stade reproductive ($t_1 \le t \le T$)}
			\begin{equation}
				\left\{\begin{array}{l}
	...
	\begin{frame}{Variables du modèle}
		...
		\begin{overprint}%{\textwidth}{\textheight}
			\onslide*<+-+(1)>{%\begin{block}{Variables du modèle}
				...
				\vskip \baselineskip
				\onslide<+->{
					Nous ajoutons $M$ qui est qui est capacité limite que la population de maïs peut atteindre en décroissant par l'effet du ravageur. \note{Puisque FAO}
				}
