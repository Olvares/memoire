...
\lstdefinestyle{code}{
	%emphstyle=\bfseries\styleD,%\color{blue!70!black}, % les mots réservés de matlab en bleu
	%basicstyle=\mlttfamily,
	basicstyle=\fontsize{12pt}{12pt}\styleD,
	mlunquotedstringdelim={þ}{þ},
	%backgroundcolor=\color{blue!05},
	%keywordstyle=\styleD,%\ttfamily,
	%commentstyle=\color{green!45!black}\styleC, % commentaire en vert
	%numberstyle=\tiny\color{red}, % Couleur de la numérotation des lignes de codes
	%numbers=none,%left,
	%numbersep=10pt,
	%lineskip=0.8pt,
	title = {\bf Code Matlab},
	%mlshowstringspaces=false
}
%  % inclure le fichier source
\newcommand{\Matlab}[1]{%
	\lstinputlisting[texcl=true,
					style=Matlab-editor,
					style=code
					]{#1}
} % A Revoir