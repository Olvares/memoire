...
\supervisor{Dr. Ir. Géraud \textsc{Azehoun-Pazou}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
\examiner{} % Your examiner's name, this is not currently used anywhere in the template, print it elsewhere with \examname
\degree{Doctor of Philosophy} % Your degree name, this is used in the title page and abstract, print it elsewhere with \degreename
\author{Aurel J. Sèlidji \textsc{Agbodoyetin}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
